...
ATest::ATest()
{
	...
	CustomMesh = CreateDefaultSubobject<UProceduralMeshComponent>("ProceduralMesh");
}
...
void ATest::MarchingTest()
{
	
}
void ATest::AddTriangle(int32 V1, int32 V2, int32 V3)
{
	Triangles.Add(V1);
	Triangles.Add(V2);
	Triangles.Add(V3);
